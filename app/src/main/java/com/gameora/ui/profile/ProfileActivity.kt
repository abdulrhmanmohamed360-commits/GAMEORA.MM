...
import com.gameora.ui.orders.SellerOrdersActivity
import com.gameora.ui.products.ProductsActivity
import com.gameora.ui.sell.SellActivity
import com.gameora.ui.support.SupportActivity
...
class ProfileActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            requireLogin {
                startActivity(
                    Intent(this, ProductsActivity::class.java).apply {
                        putExtra(
                            com.gameora.ui.common.Nav.TITLE,
                            getString(R.string.my_products)
                        )
                    }
                )
            }
        ...
        binding.profileSellerOrdersCard.setOnClickListener {
            requireLogin {
                startActivity(
                    Intent(this, SellerOrdersActivity::class.java)
                )
            }
        }

        binding.profileSupportCard.setOnClickListener {
            requireLogin {
                startActivity(
        ...
        vm.user.observe(this) { state ->
            ...
            if (state is UiState.Success) {
                ...
                binding.profileRating.text =
                    Formatters.rating(u.rating)

                binding.profileVerified.visibility =
                    if (u.verified) {
                        View.VISIBLE
                    } else {
                        View.GONE
