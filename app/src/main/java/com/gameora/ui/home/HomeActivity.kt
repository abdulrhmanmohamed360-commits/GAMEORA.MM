...
class HomeActivity :
    ...
    /*
     * من Android 13 (API 33) لازم نطلب صلاحية إظهار الإشعارات
     * صراحة، وإلا الـ Push Notifications الحقيقية (FCM) هتوصل
     * للجهاز بس مش هتتعرض للمستخدم خالص.
     */
    private val notificationPermissionLauncher =
        registerForActivityResult(
            ActivityResultContracts.RequestPermission()
        ) { /* سواء وافق أو رفض، مفيش حاجة إضافية مطلوبة هنا. */ }
